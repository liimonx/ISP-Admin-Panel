...
// Main router configuration - should be fetched from backend
// These are fallback values, actual config should come from API
export const MAIN_ROUTER_IP = "192.168.1.1"; // Default main router IP
...
class RouterService {
  ...
  async testMainRouterConnection(): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/test-connection/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterStatus(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/status/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterInterfaces(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/interfaces/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterBandwidth(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/bandwidth/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterConnections(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/connections/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterDHCPLeases(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/dhcp-leases/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterFirewallRules(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/firewall-rules/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterResources(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/resources/`);
      return response.data;
    } catch (error) {
  ...
  async executeMainRouterCommand(command: string): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/execute-command/`, {
        command,
      });
      return response.data;
    } catch (error) {
  ...
  async getMainRouterLogs(limit: number = 100): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/logs/`, {
        params: { limit },
      });
      return response.data;
    } catch (error) {
  ...
  async getMainRouterBackup(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/backup/`);
      return response.data;
    } catch (error) {
  ...
  async restoreMainRouterBackup(backupData: any): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/restore/`, backupData);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterWirelessClients(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/wireless-clients/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterQueueTree(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/queue-tree/`);
      return response.data;
    } catch (error) {
  ...
  async addBandwidthLimit(clientIP: string, downloadLimit: string, uploadLimit: string): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/bandwidth-limit/`, {
        client_ip: clientIP,
  ...
  async removeBandwidthLimit(clientIP: string): Promise<any> {
    try {
      const response = await axios.delete(`${this.baseUrl}/main-router/bandwidth-limit/`, {
  ...
  async getMainRouterRealTimeData(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/realtime/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterAlerts(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/alerts/`);
      return response.data;
    } catch (error) {
  ...
  async acknowledgeMainRouterAlert(alertId: string): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/alerts/${alertId}/acknowledge/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterPerformanceMetrics(timeRange: string = "24h"): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/performance/`, {
  ...
  async getMainRouterSecurityStatus(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/security/`);
      return response.data;
    } catch (error) {
  ...
  async updateMainRouterSecuritySettings(settings: any): Promise<any> {
    try {
      const response = await axios.put(`${this.baseUrl}/main-router/security/`, settings);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterFirmwareInfo(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/firmware/`);
      return response.data;
    } catch (error) {
  ...
  async checkMainRouterFirmwareUpdates(): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/firmware/check-updates/`);
      return response.data;
    } catch (error) {
  ...
  async updateMainRouterFirmware(): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/firmware/update/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterConfigSummary(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/config-summary/`);
      return response.data;
    } catch (error) {
  ...
  async exportMainRouterConfig(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/export-config/`, {
        responseType: 'blob',
      });
      return response.data;
    } catch (error) {
  ...
  async importMainRouterConfig(configFile: File): Promise<any> {
    try {
      ...
      const response = await axios.post(`${this.baseUrl}/main-router/import-config/`, formData, {
        headers: {
  ...
  async getMainRouterHealthCheck(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/health-check/`);
      return response.data;
    } catch (error) {
  ...
  async restartMainRouter(): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/restart/`);
      return response.data;
    } catch (error) {
  ...
  async shutdownMainRouter(): Promise<any> {
    try {
      const response = await axios.post(`${this.baseUrl}/main-router/shutdown/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterEnvironmentalData(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/environmental/`);
      return response.data;
    } catch (error) {
  ...
  async getMainRouterPowerConsumption(): Promise<any> {
    try {
      const response = await axios.get(`${this.baseUrl}/main-router/power-consumption/`);
      return response.data;
    } catch (error) {
